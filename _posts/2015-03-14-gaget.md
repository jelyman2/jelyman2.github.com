...
![](https://i2.wp.com/johnathanlyman.com/wp-content/uploads/2015/03/logo_black.png?resize=301%2C89)There’s a sick little iPhone and OS X app called [GAget](http://gagetapp.com). It’s sole purpose is to provide you with just-the-meat of your [Google Analytics](https://google.com/analytics) data including visitor sessions, bounce rate, new visitor percentage, and visit length. On iOS, this comes in the form of a super clean app that you can scroll though. On OS X, it’s a notification center widget. Both are super sexy.
